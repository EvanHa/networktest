...
/* eL2440 ramdisk info */
unsigned long phys_initrd_start __initdata = 0x30800000; // down load address for ramdisk.gz
unsigned long phys_initrd_size __initdata = 0x600000;    // Max. 6MB for zip file  
